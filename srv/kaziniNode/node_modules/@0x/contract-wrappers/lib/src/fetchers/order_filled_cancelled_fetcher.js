...
var OrderFilledCancelledFetcher = /** @class */ (function () {
    ...
    OrderFilledCancelledFetcher.prototype.isOrderCancelledAsync = function (signedOrder) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this._exchange.isCancelledAsync(orderHash)];
                    case 1:
                        isCancelled = _a.sent();
                        return [4 /*yield*/, this._exchange.getOrderEpochAsync(signedOrder.makerAddress, signedOrder.senderAddress, {
                                defaultBlock: this._stateLayer,
                            })];
                    case 2:
                        orderEpoch = _a.sent();
