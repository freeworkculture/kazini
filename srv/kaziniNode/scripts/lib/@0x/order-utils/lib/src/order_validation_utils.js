...
var OrderValidationUtils = /** @class */ (function () {
     ...
     */
    function OrderValidationUtils(orderFilledCancelledFetcher, provider) {
    ...
    OrderValidationUtils.prototype.validateFillOrderThrowIfInvalidAsync = function (exchangeTradeEmulator, provider, signedOrder, fillTakerAssetAmount, takerAddress, zrxAssetData) {
        return __awaiter(this, void 0, void 0, function () {
            var orderHash, isValid, filledTakerTokenAmount, remainingTakerTokenAmount, desiredFillTakerTokenAmount, err_1, transferFailedErrorMessages, wouldRoundingErrorOccur;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
